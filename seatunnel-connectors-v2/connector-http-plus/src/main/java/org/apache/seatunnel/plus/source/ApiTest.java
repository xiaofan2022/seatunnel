...
public class ApiTest {
    ...
    private static final String appKey = "34289603"; // 可替换为您的应用的appKey
    private static final String appSecret =
            "015e246d33f2479453d0cb9f588df501"; // 可替换为您的应用的appSecret
    ...
    private static String getSellerItem() throws IOException {
        ...
        params.put("customer_id", "11276573");
        params.put("target_app_key", "23060081");
        params.put("start_time", "2023-10-01");
        params.put("end_time", "2023-10-07");
    ...
    /** 对TOP请求进行签名。 */
    public static String signTopRequest(
            Map<String, String> params, String secret, String signMethod) throws IOException {
        // 第一步：检查参数是否已经排序
    ...
    private static String callApi(URL url, Map<String, String> params) throws IOException {
        ...
        try {
            ...
            conn.setRequestProperty(
                    "Content-Type", "application/x-www-form-urlencoded;charset=" + CHARSET_UTF8);
